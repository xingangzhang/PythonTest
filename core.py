...
class Request(object):
    ...
    def __setattr__(self, name, value):
        """
        检查self.method是否为_METHODS 定义的方法，在self.url = None|self.headers = dict()| self.method = None每次属性赋值时调用
        '__setattr__'函数是内建函数，用来设置对象的属性，通过object中的__setattr__函数来设置属性
        """
    ...
    def _get_opener(self):
        ...
        如果需要验证，根据 urllib提供的函数，进行请求的验证，如果不需要，则直接返回 urllib.urlopen
        """
...
print get('http://www.baidu.com').headers
